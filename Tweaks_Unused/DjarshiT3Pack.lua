...
local function addC(conName,newUnit)
    if UnitDefs[conName] and UnitDefs[conName].buildoptions and not table.contains(UnitDefs[conName].buildoptions, newUnit) then
    ...
    h(
        ...
        m .. "nanotct3",
        {
            ...
            customparams = {
                ...
                i18n_en_tooltip = "Maximum BUILDPOWER! (Ripped from NuttyB, tweaked by Djarshi & txpera)"
            }
        }
    )
    h(
...
local newT3Mex = mergeToNew( 
        ...
        "t3mmex",
        {
            ...
            customparams = {
                ...
                i18n_en_tooltip = "Metal Extraction / Storage (OP by FiendishDevil)",
            },
        }
    )
...
UnitDefs["corjugg"].metalcost=UnitDefs["corjugg"].metalcost*2
UnitDefs["legeheatraymech"].metalcost=UnitDefs["legeheatraymech"].metalcost*2
if (UnitDefs["legeheatraymech_old"]) then
    UnitDefs["legeheatraymech_old"].metalcost=UnitDefs["legeheatraymech_old"].metalcost*2
end
...
UnitDefs["legjim"].health = 0
UnitDefs["legjim"].maxthisunit = 0
